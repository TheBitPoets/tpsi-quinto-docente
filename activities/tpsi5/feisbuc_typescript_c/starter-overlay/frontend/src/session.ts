...
import type { AuthStatus, LoginCredentials, RegistrationCredentials, User } from "./domain";
...
async function ensureKnown(): Promise<AuthStatus> {
  ...
  try {
    userState.value = (await api.me()).user;
...
export const session = {
  ...
  ensureKnown, login, register, logout, markAnonymous,
};
