...
Non modificare `app.js` finche non hai compilato almeno cinque righe sostanziali.

| # | Sintomo osservato | Causa tecnica / riga o costrutto | Evidenza in DevTools | Fix proposto | Verifica dopo il fix |
| --- | --- | --- | --- | --- | --- |
| 1 |  |  |  |  |  |
| 2 |  |  |  |  |  |
| 3 |  |  |  |  |  |
