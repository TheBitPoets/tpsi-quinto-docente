...
import { createPostEvents } from "./post-events.js";
...
const postEvents = createPostEvents();
const app = createApp({ authStore, postStore, postEvents, config, staticDir });
const server = createServer(app);
const realtime = attachRealtime({ httpServer: server, authStore, config, postEvents });
