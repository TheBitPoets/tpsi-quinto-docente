...
- `const` viene interpretato come immutabilità profonda;
...
Il punto non è la sintassi compatta, ma la corrispondenza fra intenzione e codice.

## Grading

I test deterministici sono autoritativi sull'output. La rubrica completa richiede anche spiegazione e qualità del codice: un output corretto ottenuto con hard-code non soddisfa la parte manuale.
