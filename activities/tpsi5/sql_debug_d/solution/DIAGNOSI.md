...
| 3 | vengono eliminate piu righe del previsto | `WHERE id <> 'p1'` descrive p2, p3 e remove-me | solo `id='remove-me'` | usare uguaglianza sul target | rimangono esattamente p1, p2, p3 |
