...
REALTIME_BACKEND = ROOT / "activities" / "tpsi5" / "feisbuc_realtime_c" / "solution" / "backend"
FRONTEND_DIST = ROOT / "_realtime-frontend" / "dist"
DEST = ROOT / "_realtime-reference"
...
def main() -> None:
    ...
    copy_tree(REALTIME_BACKEND, DEST, dirs_exist_ok=True)
